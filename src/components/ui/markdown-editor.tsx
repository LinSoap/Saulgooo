    ...
    <ProseKit editor={editor}>
      <div className="relative h-full w-full overflow-y-auto">
        <div
          ...
          className={cn(
            // 基础样式
            "ProseMirror min-h-full px-6 py-8 outline-none md:px-[max(4rem,calc(50%-20rem))]",
            // 占位符样式
            placeholder &&
              "[&_.ProseMirror-is-empty]:before:pointer-events-none [&_.ProseMirror-is-empty]:before:absolute [&_.ProseMirror-is-empty]:before:right-6 [&_.ProseMirror-is-empty]:before:left-6 [&_.ProseMirror-is-empty]:before:text-gray-400 [&_.ProseMirror-is-empty]:before:content-[attr(data-placeholder)] md:[&_.ProseMirror-is-empty]:before:right-[max(4rem,calc(50%-20rem))] md:[&_.ProseMirror-is-empty]:before:left-[max(4rem,calc(50%-20rem))]",
            className,
          )}
