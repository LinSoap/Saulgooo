...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-full text-sm font-medium transition-all disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg:not([class*='size-'])]:size-4 shrink-0 [&_svg]:shrink-0 outline-none focus-visible:border-ring focus-visible:ring-ring/50 focus-visible:ring-[3px] aria-invalid:ring-destructive/20 dark:aria-invalid:ring-destructive/40 aria-invalid:border-destructive",
  {
    variants: {
      variant: {
        default:
          "bg-brand-black text-white hover:bg-brand-dark shadow-xl shadow-gray-200",
        destructive:
          "bg-destructive text-white hover:bg-destructive/90 focus-visible:ring-destructive/20 dark:focus-visible:ring-destructive/40 dark:bg-destructive/60",
        outline:
          "border border-gray-200 bg-transparent hover:bg-gray-50 text-gray-700",
        secondary:
          "bg-white border border-gray-200 text-gray-700 hover:bg-gray-50",
        ghost: "hover:bg-gray-100 text-gray-700 dark:hover:bg-accent/50",
        link: "text-brand-black underline-offset-4 hover:underline",
      },
      size: {
        default: "h-14 px-6 py-4 has-[>svg]:px-4",
        sm: "h-9 rounded-full gap-1.5 px-4 has-[>svg]:px-3",
        lg: "h-16 rounded-full px-8 has-[>svg]:px-6",
