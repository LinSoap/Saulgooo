...
Create a dedicated folder for your article in your current workspace:
```
mkdir 文章标题
cd 文章标题
```
...
4. **Version your drafts**: 文章-第一版.md, 文章-第二版.md, etc.
...
./文章名称/
├── 大纲.md              # Your outline
├── 研究资料.md           # All research and citations
├── 草稿-v1.md           # First draft
├── 草稿-v2.md           # Revised draft
├── 终稿.md              # Publication-ready
├── 反馈.md              # Collected feedback
